...
const Template1: React.FC<{ data: CVData }> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col min-h-[297mm] w-[210mm] text-black font-sans bg-white overflow-visible relative pt-0 print:pt-[35mm]">
      {/* 1. FIXED SIDEBAR BACKGROUND (Infinite vertical line) */}
      <div className="hidden print:block fixed top-0 left-0 w-[32%] h-full bg-[#E5E7EB] z-0" />

      {/* 2. FIXED METADATA HEADER (Visible on Page 2+) - Height locked at 25mm to create gap with content */}
      <div className="hidden print:flex fixed top-0 left-0 w-full justify-between px-10 h-[25mm] items-center text-[7.5pt] text-gray-400 z-10">
      ...
      {/* 3. PAGE 1 HEADER (Pulls itself up by 35mm to achieve Full Bleed and cover metadata) */}
      <div className="z-30 relative flex flex-col print:mt-[-35mm]">
        {/* Full-Bleed Box (Photo + Name) */}
        <div className="flex h-[180px] border-b-2 border-black bg-white overflow-hidden relative">
          {/* Sidebar color for the header box area */}
          <div className="absolute top-0 left-0 w-[32%] h-full bg-[#E5E7EB] z-0" />
          
          {/* Photo Box */}
          <div className="w-[180px] h-full border-r-2 border-black flex-shrink-0 z-10 relative">
            {personal.photo ? (
          ...
          {/* Name Area */}
          <div className="flex-1 flex items-center justify-center px-10 z-10 relative bg-white">
      ...
      <div className="flex flex-1 relative z-20">
        ...
        <div className="w-[32%] flex flex-col pt-10 pb-10 bg-[#E5E7EB] print:bg-transparent">
          <div className="px-8 space-y-8">
            ...
            <section className="break-avoid">
              <h2 className="text-lg font-black uppercase tracking-[0.2em] mb-4 border-b border-gray-400 pb-1 text-gray-500 font-sans">Personal</h2>
            ...
            {fallbackInterests.length > 0 && (
              <section className="break-avoid pt-4">
                <h2 className="text-lg font-black uppercase tracking-[0.2em] mb-4 border-b border-gray-400 pb-1 text-gray-500 font-sans">Interests</h2>
        ...
        <div className="w-[68%] p-10 bg-white space-y-10 z-10">
          ...
          {work.length > 0 && (
            <section>
              <h2 className="text-lg font-black uppercase tracking-[0.2em] mb-6 border-b border-black pb-1 leading-none text-black font-sans">Work Experience</h2>
          ...
          {education.length > 0 && (
            <section>
              <h2 className="text-lg font-black uppercase tracking-[0.2em] mb-6 border-b border-black pb-1 leading-none text-black font-sans">Education and Qualifications</h2>
              <div className="space-y-10">
          ...
          {skills.length > 0 && (
            <section className="break-inside-avoid">
              <h2 className="text-lg font-black uppercase tracking-[0.2em] mb-8 border-b border-black pb-1 leading-none text-black font-sans">Skills</h2>
                ...
                {skills.map((skill, index) => {
                  ...
                  return (
                    <div key={typeof skill === 'string' ? index : skill.id} className="flex items-center justify-between group">
                      <span className="text-[10.5pt] font-black uppercase tracking-tight text-gray-800 font-sans">{name}</span>
